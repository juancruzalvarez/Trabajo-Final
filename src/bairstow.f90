module bairstow
   ...
   function aplicar_bairstow(grado, coeficientes, cota_error)
      ...
      real(kind=8), dimension(4)       :: valores_actuales
      ...
      valores_actuales(3) = cota_error*2
      i = 0
      do while((valores_actuales(3) > cota_error .or. valores_actuales(4) > cota_error).and. i < MAX_ITER)
   ...
   function iteracion_bairstow(grado, coeficientes, uv)
      ...
      integer                          :: grado, i
      real(kind=8), dimension(4)       :: iteracion_bairstow, uv
      ...
      iteracion_bairstow(3) = abs(q(grado+1))
      iteracion_bairstow(4) = abs(q(grado))
